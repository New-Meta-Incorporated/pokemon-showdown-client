...
export const BattleMoveAnims: AnimTable = {
	...
	planetarywrath:{
		...
		scene.backgroundEffect("url('https://"+Config.routes.client+"/fx/bg-space.jpg')",900,0.5);
	...
	mercurywave: {
		anim(scene, [attacker, ...defenders]) {
			...
			scene.backgroundEffect('#686868', 700, 0.4);
	...
	sunhammer: {
		anim(scene, [attacker, defender]) {
			...
			scene.backgroundEffect('linear-gradient(#969205 30%, #B4B836)', 500, 0.6);
			scene.backgroundEffect('linear-gradient(#FFFFFF 30%, #B4B836)', 1200, 0.6, 500);
...
BattleMoveAnims['spiritsap']={anim:BattleMoveAnims['hex'].anim};
BattleMoveAnims['thinkfast']={anim:BattleMoveAnims['psyshock'].anim};
BattleMoveAnims['spookytricks']={anim:BattleMoveAnims['trickortreat'].anim};
BattleMoveAnims['firejet']={anim:BattleMoveAnims['flamecharge'].anim};
BattleMoveAnims['fungalbomb']={anim:BattleMoveAnims['seedbomb'].anim};
BattleMoveAnims['chillingwave']={anim:BattleMoveAnims['icywind'].anim};
BattleMoveAnims['focusup']={anim:BattleMoveAnims['dragondance'].anim};
BattleMoveAnims['suddenzap']={anim:BattleMoveAnims['wildcharge'].anim};
BattleMoveAnims['diamonddust']={anim:BattleMoveAnims['diamondstorm'].anim};
BattleMoveAnims['magicdarts']={anim:BattleMoveAnims['thousandarrows'].anim};
BattleMoveAnims['toxiccloud']={anim:BattleMoveAnims['haze'].anim};
BattleMoveAnims['landslide']={anim:BattleMoveAnims['earthquake'].anim};
BattleMoveAnims['nightmaredance']={anim:BattleMoveAnims['dragondance'].anim};
BattleMoveAnims['darkwhispers']={anim:BattleMoveAnims['neverendingnightmare'].anim};
BattleMoveAnims['shieldbeam']={anim:BattleMoveAnims['flashcannon'].anim};
BattleMoveAnims['waterbullet']={anim:BattleMoveAnims['waterpulse'].anim};
BattleMoveAnims['poisonhorn']={anim:BattleMoveAnims['megahorn'].anim};
BattleMoveAnims['prehistoricwisdom']={anim:BattleMoveAnims['calmmind'].anim};
BattleMoveAnims['pollenhazard']={anim:BattleMoveAnims['spore'].anim};
BattleMoveAnims['magicdust']={anim:BattleMoveAnims['spore'].anim};
BattleMoveAnims['crystalwave']={anim:BattleMoveAnims['icywind'].anim};
BattleMoveAnims['triplepeck']={anim:BattleMoveAnims['furyattack'].anim};
BattleMoveAnims['purifyingflame']={anim:BattleMoveAnims['sacredfire'].anim};
BattleMoveAnims['windblast']={anim:BattleMoveAnims['twister'].anim};
BattleMoveAnims['revengeblast']={anim:BattleMoveAnims['hyperbeam'].anim};
BattleMoveAnims['anticyclone']={anim:BattleMoveAnims['weatherball'].anim};
BattleMoveAnims['speedstrike']={anim:BattleMoveAnims['extremespeed'].anim};
BattleMoveAnims['sleepbubble']={anim:BattleMoveAnims['bubblebeam'].anim};
BattleMoveAnims['psychocrash']={anim:BattleMoveAnims['gigaimpact'].anim};
BattleMoveAnims['rockseal']={anim:BattleMoveAnims['stealthrock'].anim};
BattleMoveAnims['prismbeam']={anim:BattleMoveAnims['triattack'].anim};
BattleMoveAnims['toxicfortune']={anim:BattleMoveAnims['sludgewave'].anim};
BattleMoveAnims['frostychaw']={anim:BattleMoveAnims['icefang'].anim};
BattleMoveAnims['venomousrend']={anim:BattleMoveAnims['poisonfang'].anim};
BattleMoveAnims['clearlight']={anim:BattleMoveAnims['healbell'].anim};
BattleMoveAnims['lightspeed']={anim:BattleMoveAnims['extremespeed'].anim};
BattleMoveAnims['blindingblast']={anim:BattleMoveAnims['heatwave'].anim};
BattleMoveAnims['shadowyblast']={anim:BattleMoveAnims['darkpulse'].anim};
BattleMoveAnims['lightwave']={anim:BattleMoveAnims['lightofruin'].anim};
BattleMoveAnims['photondischarge']={anim:BattleMoveAnims['zapcannon'].anim};
BattleMoveAnims['solarorb']={anim:BattleMoveAnims['solarbeam'].anim};
BattleMoveAnims['meteorshower']={anim:BattleMoveAnims['swift'].anim};
BattleMoveAnims['flashbeam']={anim:BattleMoveAnims['zapcannon'].anim};
BattleMoveAnims['glowingbram']={anim:BattleMoveAnims['flash'].anim};
BattleMoveAnims['moonritual']={anim:BattleMoveAnims['dragondance'].anim};
BattleMoveAnims['abduction']={anim:BattleMoveAnims['skydrop'].anim};
BattleMoveAnims['implosion']={anim:BattleMoveAnims['darkpulse'].anim};
BattleMoveAnims['forcefield']={anim:BattleMoveAnims['calmmind'].anim};
BattleMoveAnims['draconicfangs']={anim:BattleMoveAnims['crunch'].anim};
BattleMoveAnims['blindingflash']={anim:BattleMoveAnims['flash'].anim};
BattleMoveAnims['dazzlingshock']={anim:BattleMoveAnims['skullbash'].anim};
BattleMoveAnims['vacuumray']={anim:BattleMoveAnims['confuseray'].anim};
BattleMoveAnims['wagondance']={anim:BattleMoveAnims['dragondance'].anim};
BattleMoveAnims['vengefulspirit']={anim:BattleMoveAnims['phazingphantasm'].anim};
BattleMoveAnims['nebulaburst']={anim:BattleMoveAnims['implosion'].anim};
BattleMoveAnims['tsunami']={anim:BattleMoveAnims['surf'].anim};
BattleMoveAnims['spiritcalling']={anim:BattleMoveAnims['beatup'].anim};
BattleMoveAnims['pressurepoint']={anim:BattleMoveAnims['healblock'].anim};
BattleMoveAnims['wingwind']={anim:BattleMoveAnims['hurricane'].anim};
BattleMoveAnims['mythicarrows']={anim:BattleMoveAnims['thousandarrows'].anim};
BattleMoveAnims['ragnarok']={anim:BattleMoveAnims['earthquake'].anim};
BattleMoveAnims['hyperwoophole']={anim:BattleMoveAnims['hyperspacehole'].anim};
BattleMoveAnims['hyperwoopfury']={anim:BattleMoveAnims['hyperspacefury'].anim};
BattleMoveAnims['raid']={anim:BattleMoveAnims['bulletseed'].anim};
BattleMoveAnims['deathray']={anim:BattleMoveAnims['hyperbeam'].anim};
BattleMoveAnims['brightclaw']={anim:BattleMoveAnims['dragonclaw'].anim};
BattleMoveAnims['dazingraze']={anim:BattleMoveAnims['dazingpressure'].anim};
BattleMoveAnims['tribaltoxins']={anim:BattleMoveAnims['toxic'].anim};
BattleMoveAnims['calcitecrash']={anim:BattleMoveAnims['flareblitz'].anim};
BattleMoveAnims['earthenshell']={anim:BattleMoveAnims['aurasphere'].anim};
BattleMoveAnims['mysticalfang']={anim:BattleMoveAnims['hyperfang'].anim};
BattleMoveAnims['regrowth']={anim:BattleMoveAnims['synthesis'].anim};
BattleMoveAnims['antidote']={anim:BattleMoveAnims['synthesis'].anim};
BattleMoveAnims['cloakedassault']={anim:BattleMoveAnims['feintattack'].anim};
BattleMoveAnims['ironmaw']={anim:BattleMoveAnims['crunch'].anim};
BattleMoveAnims['veiloflight']={anim:BattleMoveAnims['flash'].anim};
BattleMoveAnims['nosedive']={anim:BattleMoveAnims['skyattack'].anim};
BattleMoveAnims['burningbarrage']={anim:BattleMoveAnims['flameburst'].anim};
BattleMoveAnims['mindpulse']={anim:BattleMoveAnims['psychic'].anim};
BattleMoveAnims['neurotoxicdart']={anim:BattleMoveAnims['thousandarrows'].anim};
BattleMoveAnims['jadeblade']={anim:BattleMoveAnims['xscissor'].anim};
BattleMoveAnims['windscythe']={anim:BattleMoveAnims['aerialace'].anim};
